 ...
 * objects.
 */
public class PassengerActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    faceDetector
            ...
            .addOnSuccessListener(new OnSuccessListener<List<Face>>() {
              ...
              public void onSuccess(List<Face> faces) {
                //Count No. Of People
                int countOfPeople = faces.size();
                TextView textView = (TextView)findViewById(R.id.textView);
                textView.setText("Count: " + Integer.toString(countOfPeople));
